...
public class CreditGeneticAlgorithm {
...
//            System.out.println(df.format(error));
    ...
    public static void main(String[] args) {
        ...
        BackPropagationNetworkFactory factory = new BackPropagationNetworkFactory();
        BackPropagationNetwork network = factory.createClassificationNetwork(new int[]{23, 19, 2});
        ...
        OptimizationAlgorithm oa = new StandardGeneticAlgorithm(230, 165, 20, nnop);
        runNeuralNetwork(oa, 23, 19, 2, set, measure, trainInstances, testInstances, 20, 100);
    }
}
